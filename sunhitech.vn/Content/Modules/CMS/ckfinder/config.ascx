...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip","svg" };
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png","svg" };
        type.DeniedExtensions = new string[] { };
        ...
        {
            type.Url = BaseUrl;
            type.AllowedExtensions = new string[] { "doc", "docx", "pdf", "ppdf", "pxd", "cvs", "epdf", "xls","xlsx", "ppt", "pptx", "html", "htm", "rar", "txt", "7z","gz","gzip", "zip" };
        }
        else
        {
            type.Url = BaseUrl + "documents/";
            type.AllowedExtensions = new string[] { "doc", "docx", "pdf", "ppdf", "pxd", "cvs", "epdf", "xls","xlsx", "ppt", "pptx", "html", "htm","svg" };
        }
        type.MaxSize = 0;
